...
object NetworkConfig {
     ...
     */
    const val DEV_EMULATOR_BASE_URL = "http://10.0.2.2:3000/api/v1/"
    
    /**
     * Base URL when using adb reverse or local loopback.
     */
    const val DEV_LOCALHOST_BASE_URL = "http://127.0.0.1:3000/api/v1/"
    
    /**
     * Placeholder for staging environment (HTTPS required).
     */
    const val STAGING_BASE_URL = "https://staging.movieapp.com/api/v1/"
    
    /**
     * Placeholder for production environment (HTTPS required).
     */
    const val PROD_BASE_URL = "https://api.movieapp.com/api/v1/"
